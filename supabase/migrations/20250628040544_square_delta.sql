/*
  # Learning Modules and Quiz System Setup

  1. New Tables
    - `quiz_questions` table for storing quiz questions
  
  2. Sample Data
    - 8 learning modules (6 regular + 2 quiz modules)
    - 16 quiz questions (2 per module)
...
(
  '87654321-4321-8765-cba9-fed210987654'::uuid,
