/*
  # Learning System Setup with Demo Data

  1. Learning Modules
    - Create comprehensive learning modules with proper content
    - Add quiz questions for each module (2 questions each)
    - Set up proper prerequisites and difficulty levels

  2. Demo Users
    - Sarah Johnson (Beginner level user)
    - Michael Chen (Intermediate level user)
    - Complete profiles, goals, XP, and learning progress

  3. Security
    - Enable RLS on quiz_questions table
    - Add public read access for quiz questions
*/
