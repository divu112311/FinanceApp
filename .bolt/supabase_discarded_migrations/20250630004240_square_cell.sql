/*
  # Enhanced Learning System with Knowledge Tracking

  1. New Tables
    - `user_knowledge_areas` - Tracks user's understanding of financial concepts
    - `financial_concepts` - Master list of financial concepts and their relationships
    - `default_learning_modules` - Pre-generated content for new users
  
  2. Changes
    - Added knowledge tracking system
    - Enhanced content queue with difficulty progression
    - Added default content for new users
    - Improved content generation logic
*/
...
-- Create table for financial concepts
...
VALUES
  ('Budgeting 101: Getting Started', 'Learn the fundamentals of creating a budget that works for your lifestyle', 'article', 'Beginner', 'Budgeting', 15, 25, 
   '{
     "sections": [
       {"title": "Why Budgeting Matters", "content": "Budgeting is the foundation of financial success. It helps you understand where your money goes, ensures you live within your means, and enables you to prioritize your spending according to your values and goals."},
       {"title": "The 50/30/20 Rule", "content": "A simple way to start budgeting is the 50/30/20 rule. Allocate 50% of your income to needs (housing, food, utilities), 30% to wants (entertainment, dining out), and 20% to savings and debt repayment."},
       {"title": "Tracking Your Expenses", "content": "The first step in creating a budget is understanding your current spending. Track all expenses for at least 30 days, categorizing each transaction to identify patterns and areas for improvement."},
       {"title": "Setting Realistic Goals", "content": "Your budget should reflect your financial goals. Whether you're saving for a vacation, paying off debt, or building an emergency fund, your budget is the roadmap to get there."}
     ],
  ...
  ('Emergency Fund Essentials', 'Discover why emergency funds are crucial and how to build one', 'article', 'Beginner', 'Savings', 12, 20, 
   '{
     "sections": [
       {"title": "What Is an Emergency Fund?", "content": "An emergency fund is money set aside specifically for unexpected expenses or financial emergencies, such as medical bills, car repairs, or job loss."},
       {"title": "How Much Should You Save?", "content": "Financial experts typically recommend saving 3-6 months of essential expenses. Start with a mini emergency fund of $1,000 while paying off high-interest debt, then build toward your full target."},
       {"title": "Where to Keep Your Emergency Fund", "content": "Your emergency fund should be liquid (easily accessible) but not too accessible (to avoid temptation). High-yield savings accounts are ideal - they offer better returns than traditional savings accounts while maintaining FDIC insurance and liquidity."},
       {"title": "Building Your Fund Gradually", "content": "Start small and be consistent. Even $25-50 per week adds up over time. Consider automating transfers to your emergency fund on payday to make saving effortless."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Understanding Credit Scores', 'Learn what makes up your credit score and how to improve it', 'article', 'Beginner', 'Credit', 15, 25, 
   '{
     "sections": [
       {"title": "What Is a Credit Score?", "content": "A credit score is a three-digit number that represents your creditworthiness. Lenders use this score to determine whether to approve you for loans and credit cards, and what interest rates to charge."},
       {"title": "Factors That Affect Your Score", "content": "Your FICO credit score is determined by: Payment History (35%), Credit Utilization (30%), Length of Credit History (15%), New Credit (10%), and Credit Mix (10%)."},
       {"title": "Checking Your Credit Report", "content": "You can get free credit reports from all three major bureaus (Equifax, Experian, and TransUnion) at AnnualCreditReport.com. Review them regularly for errors or fraudulent activity."},
       {"title": "Simple Ways to Improve Your Score", "content": "Pay all bills on time, keep credit card balances below 30% of your limits, avoid opening multiple new accounts in a short period, and keep old accounts open to maintain a longer credit history."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Debt Payoff Strategies', 'Compare different methods for eliminating debt efficiently', 'article', 'Beginner', 'Debt Management', 18, 30, 
   '{
     "sections": [
       {"title": "Debt Avalanche Method", "content": "The debt avalanche method involves paying minimum payments on all debts, then putting extra money toward the debt with the highest interest rate. This approach saves the most money in interest over time."},
       {"title": "Debt Snowball Method", "content": "The debt snowball method focuses on paying off your smallest debts first, regardless of interest rate. This creates psychological wins that can help maintain motivation throughout your debt payoff journey."},
       {"title": "Debt Consolidation Options", "content": "Consolidating multiple debts into a single loan with a lower interest rate can simplify payments and reduce interest costs. Options include balance transfer credit cards, personal loans, and home equity loans."},
       {"title": "Creating a Debt Payoff Plan", "content": "List all your debts with their balances, interest rates, and minimum payments. Choose a strategy, determine how much extra you can put toward debt each month, and track your progress to stay motivated."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Investing Basics', 'Learn the fundamentals of investing and building wealth', 'article', 'Beginner', 'Investing', 20, 35, 
   '{
     "sections": [
       {"title": "Why Invest?", "content": "Investing allows your money to grow through compound interest and appreciation, helping you build wealth and beat inflation over time. While saving is important for short-term goals, investing is crucial for long-term financial success."},
       {"title": "Types of Investments", "content": "Common investment types include stocks (ownership in companies), bonds (loans to companies or governments), mutual funds and ETFs (collections of stocks or bonds), and real estate. Each has different risk and return characteristics."},
       {"title": "Understanding Risk and Return", "content": "Generally, higher potential returns come with higher risk. Your risk tolerance depends on your financial goals, time horizon, and personal comfort with market fluctuations."},
       {"title": "Getting Started with Small Amounts", "content": "You don\'t need a lot of money to start investing. Many brokerages offer commission-free trades and no minimum investments. Consider starting with a broad-market index fund that provides instant diversification."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Setting SMART Financial Goals', 'Learn how to create effective, achievable financial goals', 'article', 'Beginner', 'Goal Setting', 15, 25, 
   '{
     "sections": [
       {"title": "What Makes a Goal SMART?", "content": "SMART goals are Specific, Measurable, Achievable, Relevant, and Time-bound. Instead of \'save more money,\' a SMART goal would be \'save $5,000 for an emergency fund by December 31st by setting aside $500 monthly.\'"},
       {"title": "Aligning Goals with Your Values", "content": "The most motivating financial goals connect to your personal values and vision for the future. Consider what truly matters to you when setting goals, whether it\'s security, freedom, family, or experiences."},
       {"title": "Short, Medium, and Long-Term Goals", "content": "Balance your financial plan with goals across different time horizons. Short-term (under 1 year), medium-term (1-5 years), and long-term (5+ years) goals work together to create a comprehensive financial strategy."},
       {"title": "Tracking Progress and Staying Motivated", "content": "Regularly review your goals, track your progress visually, celebrate milestones, and adjust as needed. Consider sharing goals with an accountability partner or financial advisor for additional support."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Understanding Compound Interest', 'Discover how compound interest can work for or against you', 'article', 'Beginner', 'Investing', 12, 20, 
   '{
     "sections": [
       {"title": "The Eighth Wonder of the World", "content": "Albert Einstein allegedly called compound interest the eighth wonder of the world, saying \'He who understands it, earns it; he who doesn\'t, pays it.\' Compound interest is interest calculated on both the initial principal and the accumulated interest from previous periods."},
       {"title": "The Rule of 72", "content": "To estimate how long it will take for your money to double, divide 72 by your annual interest rate. For example, at 8% interest, your money will double in approximately 9 years (72 ÷ 8 = 9)."},
       {"title": "The Power of Time", "content": "Starting early is crucial with compound interest. Even small amounts invested over long periods can grow substantially. For example, $1,000 invested at 8% for 40 years would grow to about $21,725, while the same amount invested for 20 years would only reach $4,661."},
       {"title": "The Dark Side: Debt", "content": "Compound interest works against you with debt, especially high-interest debt like credit cards. A $5,000 credit card balance at 18% interest would take over 30 years to pay off making only minimum payments, costing over $13,000 in interest."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Automating Your Finances', 'Learn how to set up systems that make good financial habits effortless', 'article', 'Beginner', 'Financial Planning', 15, 25, 
   '{
     "sections": [
       {"title": "Why Automation Works", "content": "Automation removes the willpower element from financial decisions, ensuring consistency even when motivation wanes. It also eliminates the risk of forgetting payments or savings contributions."},
       {"title": "Setting Up Direct Deposit Splits", "content": "Many employers allow you to split your direct deposit between multiple accounts. Consider automatically directing a percentage of your paycheck to savings or investment accounts before it hits your checking account."},
       {"title": "Automating Bill Payments", "content": "Set up automatic payments for recurring bills to avoid late fees and protect your credit score. Schedule these shortly after your regular payday to ensure sufficient funds are available."},
       {"title": "Creating a System of Savings Buckets", "content": "Use multiple savings accounts or \'buckets\' within one account for different goals. Automatically transfer money to these accounts on payday, treating savings as a non-negotiable expense."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Understanding Your Net Worth', 'Learn how to calculate and track your net worth over time', 'article', 'Beginner', 'Financial Health', 10, 20, 
   '{
     "sections": [
       {"title": "What Is Net Worth?", "content": "Net worth is the difference between your assets (what you own) and your liabilities (what you owe). It provides a snapshot of your overall financial health at a point in time."},
       {"title": "Calculating Your Net Worth", "content": "List all your assets (cash, investments, property, vehicles, etc.) and their current values. Then list all your liabilities (mortgages, loans, credit card debt, etc.). Subtract total liabilities from total assets to find your net worth."},
       {"title": "Tracking Net Worth Over Time", "content": "Your net worth will fluctuate, but the trend over time is what matters most. Calculate your net worth quarterly or semi-annually to track your financial progress."},
       {"title": "Improving Your Net Worth", "content": "Increase your net worth by growing assets (saving and investing more, increasing income) and reducing liabilities (paying down debt). Focus on high-impact actions like increasing retirement contributions or accelerating debt payments."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
  ...
  ('Credit Cards: Friend or Foe?', 'Learn how to use credit cards responsibly and avoid common pitfalls', 'article', 'Beginner', 'Credit', 15, 25, 
   '{
     "sections": [
       {"title": "The Benefits of Credit Cards", "content": "When used responsibly, credit cards offer convenience, fraud protection, rewards, and credit-building benefits. Some cards provide cash back, travel points, or other perks that can be valuable."},
       {"title": "The Dangers of Credit Card Debt", "content": "Credit cards typically charge high interest rates (often 15-25% APR). Carrying a balance can lead to a debt spiral that\'s difficult to escape, as interest compounds on both the principal and previous interest."},
       {"title": "Best Practices for Credit Card Use", "content": "Pay your balance in full each month, keep utilization below 30% of your credit limit, avoid cash advances, and choose cards with rewards that match your spending patterns. Set up automatic payments for at least the minimum due."},
       {"title": "Selecting the Right Card", "content": "Consider your spending habits, credit score, and financial goals when choosing a card. If you carry a balance, prioritize a low APR over rewards. If you pay in full, focus on rewards that align with your spending."}
     ],
     "generated_by": "default_content",
     "generated_at": "2025-06-30T00:00:00Z"
   }', 
